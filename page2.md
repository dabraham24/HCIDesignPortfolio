...
Below are 5 key points that came to define my design process this term. The projects that I discuss here are linked in the [portfolio](index.md) except for the Software Engineering project.
...
<img src="bruh.gif" width="500" align="middle"/>  
_A snippet from my demo video for Design for Tension in which we provided help and resources for prisoners who were about to be released into society._
...
Return to my [Design Portfolio](index.md).
